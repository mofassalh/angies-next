...
export default function CheckoutPage() {
  ...
  const handleSubmit = () => {
    // Will connect to Supabase + Stripe later
    clearCart()
            ...
            {step === 1 && (
              <>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 text-left transition-all ${
                        orderType === 'pickup' ? 'border-orange-400 bg-orange-50' : 'border-gray-100 hover:border-gray-200'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 text-left transition-all ${
                        orderType === 'delivery' ? 'border-orange-400 bg-orange-50' : 'border-gray-100 hover:border-gray-200'
                      }`}
                    >
                      <div className="text-2xl mb-2">🛵</div>
                ...
                <button
                  ...
                  className="w-full py-4 rounded-full text-white font-semibold transition-all hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                  ...
                  <div className="border-t border-gray-100 pt-3 space-y-1.5 text-sm">
                    ...
                    <div className="flex justify-between text-gray-500">
                      <span>GST (10%)</span><span>${getGST().toFixed(2)}</span>
                    </div>
                    {orderType === 'delivery' && (
                      <div className="flex justify-between text-gray-500">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                  ...
                  <div className="p-4 rounded-xl border-2 border-orange-200 bg-orange-50 text-sm text-orange-700 text-center">
